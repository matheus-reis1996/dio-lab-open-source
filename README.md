...
2. Clone localmente: `git clone https://github.com/SEUUSERNAME/dio-lab-open-source.git`; `git clone https://github.com/matheus-reis1996/dio-lab-open-source.git`;
...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/seunomedeusuario`; `git checkout -b feat/community/matheus-reis1996`;
    > Exemplo: `git checkout -b feat/community/elidianaandrade` `git checkout -b feat/community/matheus-reis1996`;
